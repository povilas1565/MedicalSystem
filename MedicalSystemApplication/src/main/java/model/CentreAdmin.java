...
public class CentreAdmin extends User {
    ...
    public CentreAdmin(String password, String email, String firstname, String lastname, String city,  String state, String date_of_birth, String phone, Centre centre) {
        super(password, email, firstname, lastname, city, state, date_of_birth, phone, UserRole.CentreAdmin);
        this.centre = centre;
